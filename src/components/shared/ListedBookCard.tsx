...
const ListedBookCard = ({book}:{book:IBook}) => {
    return (
        <div className="group overflow-hidden rounded-2xl border border-base-200 bg-base-100 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl grid grid-cols-1 sm:grid-cols-12">

            
            <figure className="relative  overflow-hidden bg-linear-to-br from-slate-100 to-slate-200 sm:col-span-3">
                <Image
                    src={book.image}
                    alt={book.bookName}
                    width={300}
            ...
            <div className="card-body p-5 sm:col-span-9">
